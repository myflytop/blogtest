...
<body>
    ...
    <div>
        ...
        <form action="${pageContext.request.contextPath }/bloger/blogerlogin.do" method="post">
<ul>
    <li><h3>Login</h3></li>
    <li><input type="text" name="bloger_id"></li>
    <li><input type="password" name="bloger_pas"></li>
